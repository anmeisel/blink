...
var GiphyFetch = class {
  constructor(apiKey, qsParams = {}) {
    this.getQS = (options = {}) => {
      return import_qs.default.stringify(__spreadValues(__spreadProps(__spreadValues({}, options), { api_key: this.apiKey, pingback_id: get_pingback_id_default() }), this.qsParams));
    };
    this.apiKey = apiKey;
